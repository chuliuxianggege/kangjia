...
;(function ($) {
	...
	banner.prototype = {
		...
		//构建imagemove函数
		imagemove: function imagemove(index) {
			// console.log(1);
			this.ele.find("li").eq(index).fadeIn().siblings("li").fadeOut();
		}

	};
	$.fn.extend({
		supbanner2: function supbanner2(obj, eleclass) {
			// console.log(1);
